 ...
 * @package Dravencms\Primitive\DI
 */
class SocialExtension extends Nette\DI\CompilerExtension
{
    ...
    public function loadConfiguration()
    {
        ...
        $builder->addDefinition($this->prefix('social'))
            ->setClass('Dravencms\Social\Social', []);
     ...
     */
    public static function register(Configurator $config, $extensionName = 'socialExtension')
    {
        $config->onCompile[] = function (Configurator $config, Compiler $compiler) use ($extensionName) {
            $compiler->addExtension($extensionName, new SocialExtension());
        };
    }
